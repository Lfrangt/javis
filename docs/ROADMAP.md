...
- Browser task workflows: current build supports current-page summarize, action extraction, drafting, Q&A, guarded DOM click/fill/select, and search/compare result-page capture loops; next, add deeper result-click review and fill-draft loops.
