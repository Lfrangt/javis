...
- Verifiable next task: dogfood an active voice session while Codex/Claude/local workers run, then capture evidence that the spoken answer can summarize grouped background progress on request.
