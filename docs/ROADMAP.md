...
- Verifiable next task: add a regression harness for active Realtime progress injection so grouped worker summaries are proven to be sent without forcing a spoken reply.
