...
- Creative app bridge: current build recognizes video editing and music composition tasks, chooses common NLE/DAW apps, records stage action packs for imports, timeline edits, subtitles, MIDI sketches, mix/export previews, and can open/focus/observe the selected app; next, add app-specific recovery and verified one-step execution loops.
