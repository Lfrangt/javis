...
- Multi-agent capacity preflight: support a user-facing 20-agent request as a no-side-effect planning step that reports safe concurrency, worker readiness, parallel waves, blocked lanes, and write-conflict serialization before any worker can start.
