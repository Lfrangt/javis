...
- File workflows reuse policy-guarded list/read/search actions for read-only context. Organization, batch-rename, and copy-convert workflows produce preview plans first; they do not move or copy files by themselves.
