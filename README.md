...
- Creative app workflows: recognize video editing and music composition requests, choose a likely NLE/DAW such as Final Cut Pro, DaVinci Resolve, Premiere, iMovie, CapCut, Logic Pro, GarageBand, Ableton Live, FL Studio, or Pro Tools, and stage the work before touching the UI.
...
Local Express service on 127.0.0.1:3417
  ...
  /api/creative/workflow -> plan or start video-editing/music-composition app workflows
