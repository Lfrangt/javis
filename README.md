...
- Unified perception consent/status registry through `/api/perception/consent` and `npm run config -- --print-perception`, covering screen, voice, ambient observation, browser, clipboard, Accessibility/app control, learning, and worker tools without adding desktop pet diagnostics.
