...
- Renderer provider gate before microphone startup: if recent evidence already shows Realtime quota/auth/provider failure, the desktop pet does not open the microphone and instead uses the local voice fallback.
