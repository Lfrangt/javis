...
- Realtime tool-call evidence for live voice dogfood, including sanitized shortcut list/candidate/save/forget, work-handoff, autopilot-status, attention-explanation, and perception-consent events in `/api/realtime/evidence`.
